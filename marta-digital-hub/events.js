...
$('#signup').onclick=()=>location.replace('./accesso.html?v=17');
...
window.addEventListener('storage',e=>{if(e.key==='mr_session'&&!e.newValue)location.replace('./accesso.html?v=17')});
(async()=>{if(!validSession()){clearSession();location.replace('./accesso.html?v=17');return}try{await enter()}catch(e){console.error(e);clearSession();location.replace('./accesso.html?v=17&reason=session')}})();
...
import('./library-caption-dashboard.js?v=17').catch(e=>console.error('library/caption/dashboard',e));
